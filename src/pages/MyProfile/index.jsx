    ...
    return (
        <Container fluid>
            ...
            <Row className="content-profile">
                ...
                <Col className="profile-detail" sm={3}>
                    <Row className="brown-text">Fullname</Row>
                    <Row className="black-text">Egi Ganteng</Row>
                    <Gap height={27} />
                    <Row className="brown-text">Email</Row>
                    <Row className="black-text">egigans@gmail.com</Row>
                </Col>
                <Col sm={6} className="my-trans-wrapper">
                    <Row>
                        <Col>
                            <ProductTrans/>
                            <ProductTrans/>
